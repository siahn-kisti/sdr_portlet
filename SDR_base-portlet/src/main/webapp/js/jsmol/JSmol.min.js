...
a._getZ(b,"coverImage")+';" />';d=a._appletCssText.replace(/\'/g,'"');var k=b._getSpinner&&b._getSpinner();b._spinner=k=!k||"none"==k?"":"background-image:url("+k+"); background-repeat:no-repeat; background-position:center;";d=k+(0<=d.indexOf('style="')?d.split('style="')[1]:'" '+d);d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left;margin:0 auto;">IMG WAIT......<div id="ID_appletdiv" style="z-index:'+a._getZ(b,"header")+";width:100%;height:100%;position:absolute;top:0px;left:0px;"+
...
(function(a){a._isAsync=!1;a._asyncCallbacks={};a._coreFiles=[];var m=!1,l=[],h=[],e=0,k=[],q=[],s=function(b){arguments.length||(b=!0);delete e;for(var d;0<h.length&&"done"==(d=h[0])[4];)h.shift();if(0!=h.length)if(!a._isAsync&&!b)setTimeout(s,10);else{d.push("done");var k="JSmol exec "+d[0]._id+" "+d[3]+" "+d[2];self.System;l.push(k);d[1](d[0],d[2])}},u=function(b){m?s():(m=!0,LoadClazz(),b._noMonitor&&(Clazz._LoaderProgressMonitor.showStatus=
...
function(a){D.consoleOutput(a,"red")};aa.err.println=function(a){D.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};aa.err.write=function(a,b,c){aa.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2017-06-25 16:37:45 -0400 (Sun, 25 Jun 2017) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.19.1";
