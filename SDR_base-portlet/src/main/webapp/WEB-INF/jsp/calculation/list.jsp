...
<c:if test="<%=SessionErrors.isEmpty(renderRequest)%>">
    ...
    <portlet:renderURL var="editURL">
        ...
        <portlet:param name="grId" value="0"/>
    </portlet:renderURL>

    <h3><liferay-ui:message key="Calculation"/></h3>
    ...
    <div id="board_body">
        <aui:form method="post" name="fm" action="${listURL}">
            ...
            <liferay-ui:search-container-row className="com.sdr.metadata.model.GroupRule" modelVar="vo">

                <portlet:renderURL var="viewURL">
                    <portlet:param name="action" value="view"/>
                    <portlet:param name="grId" value="${vo.grId}"/>
                </portlet:renderURL>
                ...
                <liferay-ui:search-container-column-text name="ViewAttr">
                    ${vo.viewAttr}
                </liferay-ui:search-container-column-text>
                <liferay-ui:search-container-column-text name="MergeAttr">
                    ${vo.mergeAttr}
                </liferay-ui:search-container-column-text>
