...
<liferay-portlet:renderURL var="submitCurationPopupURL">
...
<script>
	...
	YUI().use('aui-base','aui-form-validator', function(A) {
        ...
        $("#Choose1").click(function(){
            var result1 = {"value" : 0, "label" : "Curation Not Choose"};
            Liferay.Util.getOpener().popup_submitCurationPopup(result1);
		...
		A.one('#<portlet:namespace/>compositionPopupFm').delegate('click',function(event){
            ...
            Liferay.Util.getOpener().popup_submitCurationPopup(result);
			Liferay.Util.getWindow().hide();
		},'.selector-button');
