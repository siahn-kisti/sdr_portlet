 ...
 *
 */
public class VCRegisterUtilforEdison{
	 ...
	 * @password : 비밀번호
	 */
	public static int isVcInfo(long groupId, String userScreenName) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {		
		...
		if(!userScreenName.equals("")){
			...
			//GET Admin Token		
			conn.setRequestProperty("Authorization", "Basic "+TokenProviderUtilforEdison.getAdminVcToken(groupId).getVcToken());
	 ...
	 * VC계정 조회
	 */
	public static Map getVcInfo(long groupId, String userScreenName) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {		
	 ...
	 * @password : 비밀번호
	 */
	public static JSONObject VCInfoJsonSearch(long groupId, String userScreenName) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {
	 ...
	 * @password : 비밀번호
	 */
	public static int VCRegist(long groupId, String userScreenName, String password, String email, String userName,String universityField, String virtualLabId, String classId, String majorField) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {		
...
//			bodyStr.append("	\"className\" : \"className\", ");
	 ...
	 * @password : 비밀번호
	 */
	public static int VCUpdate(long groupId, String userScreenName, String password, String email) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {		
		...
		if(!CustomUtil.strNull(userScreenName).equals("") && !CustomUtil.strNull(password).equals("")){
			...
			JSONObject json = VCInfoJsonSearch(groupId, userScreenName);
	 ...
	 * @throws PortalException 
	 */
	public static int VCDeactivate(long groupId, Object params) throws IOException, ParseException, PortalException, SystemException{
		int resultCode = 0;
		StringBuffer bodyStr = new StringBuffer();
	 ...
	 * @userId : 회원아이디
	 */
	public static int VCDelete(long groupId, String userScreenName) throws MalformedURLException, IOException, ParseException, PortalException, SystemException {		
