...
import com.sdr.metadata.service.IceBreakerVcTokenLocalService;
...
/**
 * Provides the base implementation for the ice breaker vc token local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.IceBreakerVcTokenLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class IceBreakerVcTokenLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements IceBreakerVcTokenLocalService,
        IdentifiableBean {
    ...
    private IceBreakerVcTokenLocalServiceClpInvoker _clpInvoker = new IceBreakerVcTokenLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.IceBreakerVcTokenLocalServiceUtil} to access the ice breaker vc token local service.
     */
    ...
    @Override
    public IceBreakerVcToken addIceBreakerVcToken(
        IceBreakerVcToken iceBreakerVcToken) throws SystemException {
        iceBreakerVcToken.setNew(true);

        return iceBreakerVcTokenPersistence.update(iceBreakerVcToken);
    }
     ...
     */
    @Override
    public IceBreakerVcToken createIceBreakerVcToken(long tokenId) {
        return iceBreakerVcTokenPersistence.create(tokenId);
    }
    ...
    @Override
    public IceBreakerVcToken deleteIceBreakerVcToken(long tokenId)
        throws PortalException, SystemException {
        return iceBreakerVcTokenPersistence.remove(tokenId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public IceBreakerVcToken deleteIceBreakerVcToken(
        IceBreakerVcToken iceBreakerVcToken) throws SystemException {
        return iceBreakerVcTokenPersistence.remove(iceBreakerVcToken);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(IceBreakerVcToken.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return iceBreakerVcTokenPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return iceBreakerVcTokenPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public IceBreakerVcToken fetchIceBreakerVcToken(long tokenId)
        throws SystemException {
        return iceBreakerVcTokenPersistence.fetchByPrimaryKey(tokenId);
    }
     ...
     */
    @Override
    public IceBreakerVcToken getIceBreakerVcToken(long tokenId)
        throws PortalException, SystemException {
        return iceBreakerVcTokenPersistence.findByPrimaryKey(tokenId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return iceBreakerVcTokenPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<IceBreakerVcToken> getIceBreakerVcTokens(int start, int end)
        throws SystemException {
        return iceBreakerVcTokenPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getIceBreakerVcTokensCount() throws SystemException {
        return iceBreakerVcTokenPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public IceBreakerVcToken updateIceBreakerVcToken(
        IceBreakerVcToken iceBreakerVcToken) throws SystemException {
        return iceBreakerVcTokenPersistence.update(iceBreakerVcToken);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.IceBreakerVcToken",
            iceBreakerVcTokenLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = iceBreakerVcTokenPersistence.getDataSource();
