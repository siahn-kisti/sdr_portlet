...
import com.sdr.metadata.service.DatatypeRuleService;
...
/**
 * Provides the base implementation for the datatype rule remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DatatypeRuleServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class DatatypeRuleServiceBaseImpl extends BaseServiceImpl
    implements DatatypeRuleService, IdentifiableBean {
    ...
    private DatatypeRuleServiceClpInvoker _clpInvoker = new DatatypeRuleServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DatatypeRuleServiceUtil} to access the datatype rule remote service.
     */
