...
import com.sdr.metadata.service.DataViewComponentsLocalService;
...
/**
 * Provides the base implementation for the data view components local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DataViewComponentsLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class DataViewComponentsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements DataViewComponentsLocalService,
        IdentifiableBean {
    ...
    private DataViewComponentsLocalServiceClpInvoker _clpInvoker = new DataViewComponentsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DataViewComponentsLocalServiceUtil} to access the data view components local service.
     */
    ...
    @Override
    public DataViewComponents addDataViewComponents(
        DataViewComponents dataViewComponents) throws SystemException {
        dataViewComponents.setNew(true);

        return dataViewComponentsPersistence.update(dataViewComponents);
    }
     ...
     */
    @Override
    public DataViewComponents createDataViewComponents(
        long dataViewComponentsId) {
        return dataViewComponentsPersistence.create(dataViewComponentsId);
    }
    ...
    @Override
    public DataViewComponents deleteDataViewComponents(
        long dataViewComponentsId) throws PortalException, SystemException {
        return dataViewComponentsPersistence.remove(dataViewComponentsId);
    }
    ...
    public DataViewComponents deleteDataViewComponents(
        DataViewComponents dataViewComponents) throws SystemException {
        return dataViewComponentsPersistence.remove(dataViewComponents);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DataViewComponents.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return dataViewComponentsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return dataViewComponentsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DataViewComponents fetchDataViewComponents(long dataViewComponentsId)
        throws SystemException {
        return dataViewComponentsPersistence.fetchByPrimaryKey(dataViewComponentsId);
    }
     ...
     */
    @Override
    public DataViewComponents getDataViewComponents(long dataViewComponentsId)
        throws PortalException, SystemException {
        return dataViewComponentsPersistence.findByPrimaryKey(dataViewComponentsId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return dataViewComponentsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DataViewComponents> getDataViewComponentses(int start, int end)
        throws SystemException {
        return dataViewComponentsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDataViewComponentsesCount() throws SystemException {
        return dataViewComponentsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DataViewComponents updateDataViewComponents(
        DataViewComponents dataViewComponents) throws SystemException {
        return dataViewComponentsPersistence.update(dataViewComponents);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.DataViewComponents",
            dataViewComponentsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = dataViewComponentsPersistence.getDataSource();
