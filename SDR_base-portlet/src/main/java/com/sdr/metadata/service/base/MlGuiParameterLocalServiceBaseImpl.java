...
import com.sdr.metadata.service.MlGuiParameterLocalService;
...
/**
 * Provides the base implementation for the ml gui parameter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.MlGuiParameterLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class MlGuiParameterLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements MlGuiParameterLocalService,
        IdentifiableBean {
    ...
    private MlGuiParameterLocalServiceClpInvoker _clpInvoker = new MlGuiParameterLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.MlGuiParameterLocalServiceUtil} to access the ml gui parameter local service.
     */
    ...
    @Override
    public MlGuiParameter addMlGuiParameter(MlGuiParameter mlGuiParameter)
        throws SystemException {
        mlGuiParameter.setNew(true);

        return mlGuiParameterPersistence.update(mlGuiParameter);
    }
     ...
     */
    @Override
    public MlGuiParameter createMlGuiParameter(long mlGuiParameterId) {
        return mlGuiParameterPersistence.create(mlGuiParameterId);
    }
    ...
    @Override
    public MlGuiParameter deleteMlGuiParameter(long mlGuiParameterId)
        throws PortalException, SystemException {
        return mlGuiParameterPersistence.remove(mlGuiParameterId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public MlGuiParameter deleteMlGuiParameter(MlGuiParameter mlGuiParameter)
        throws SystemException {
        return mlGuiParameterPersistence.remove(mlGuiParameter);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(MlGuiParameter.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return mlGuiParameterPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return mlGuiParameterPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public MlGuiParameter fetchMlGuiParameter(long mlGuiParameterId)
        throws SystemException {
        return mlGuiParameterPersistence.fetchByPrimaryKey(mlGuiParameterId);
    }
     ...
     */
    @Override
    public MlGuiParameter getMlGuiParameter(long mlGuiParameterId)
        throws PortalException, SystemException {
        return mlGuiParameterPersistence.findByPrimaryKey(mlGuiParameterId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return mlGuiParameterPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<MlGuiParameter> getMlGuiParameters(int start, int end)
        throws SystemException {
        return mlGuiParameterPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getMlGuiParametersCount() throws SystemException {
        return mlGuiParameterPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public MlGuiParameter updateMlGuiParameter(MlGuiParameter mlGuiParameter)
        throws SystemException {
        return mlGuiParameterPersistence.update(mlGuiParameter);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.MlGuiParameter",
            mlGuiParameterLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = mlGuiParameterPersistence.getDataSource();
