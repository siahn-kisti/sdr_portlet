...
import com.sdr.metadata.service.GroupRuleLocalService;
...
/**
 * Provides the base implementation for the group rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.GroupRuleLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class GroupRuleLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements GroupRuleLocalService, IdentifiableBean {
    ...
    private GroupRuleLocalServiceClpInvoker _clpInvoker = new GroupRuleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.GroupRuleLocalServiceUtil} to access the group rule local service.
     */
    ...
    @Override
    public GroupRule addGroupRule(GroupRule groupRule)
        throws SystemException {
        groupRule.setNew(true);

        return groupRulePersistence.update(groupRule);
    }
     ...
     */
    @Override
    public GroupRule createGroupRule(long grId) {
        return groupRulePersistence.create(grId);
    }
    ...
    @Override
    public GroupRule deleteGroupRule(long grId)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public GroupRule deleteGroupRule(GroupRule groupRule)
        throws SystemException {
        return groupRulePersistence.remove(groupRule);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(GroupRule.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return groupRulePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return groupRulePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return groupRulePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public GroupRule fetchGroupRule(long grId) throws SystemException {
        return groupRulePersistence.fetchByPrimaryKey(grId);
    }
     ...
     */
    @Override
    public GroupRule getGroupRule(long grId)
        throws PortalException, SystemException,
            com.sdr.metadata.NoSuchGroupRuleException {
        return groupRulePersistence.findByPrimaryKey(grId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return groupRulePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<GroupRule> getGroupRules(int start, int end)
        throws SystemException {
        return groupRulePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getGroupRulesCount() throws SystemException {
        return groupRulePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public GroupRule updateGroupRule(GroupRule groupRule)
        throws SystemException {
        return groupRulePersistence.update(groupRule);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.GroupRule",
            groupRuleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = groupRulePersistence.getDataSource();
