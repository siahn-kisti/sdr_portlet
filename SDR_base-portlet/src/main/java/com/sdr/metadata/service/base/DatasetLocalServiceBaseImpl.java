...
import com.sdr.metadata.service.DatasetLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DatasetLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
...
public abstract class DatasetLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements DatasetLocalService, IdentifiableBean {
    ...
    private DatasetLocalServiceClpInvoker _clpInvoker = new DatasetLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DatasetLocalServiceUtil} to access the dataset local service.
     */
    ...
    @Override
    public Dataset addDataset(Dataset dataset) throws SystemException {
        dataset.setNew(true);
    ...
    @Override
    public Dataset deleteDataset(long datasetId)
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Dataset deleteDataset(Dataset dataset) throws SystemException {
    ...
    @Override
    public Dataset fetchDataset(long datasetId) throws SystemException {
     ...
     */
    @Override
    public int getDatasetsCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Dataset updateDataset(Dataset dataset) throws SystemException {
        return datasetPersistence.update(dataset);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.Dataset",
            datasetLocalService);
    }
