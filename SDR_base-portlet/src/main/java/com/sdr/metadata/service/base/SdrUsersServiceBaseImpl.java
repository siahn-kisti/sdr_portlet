...
import com.sdr.metadata.service.SdrUsersService;
...
/**
 * Provides the base implementation for the sdr users remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.SdrUsersServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class SdrUsersServiceBaseImpl extends BaseServiceImpl
    implements SdrUsersService, IdentifiableBean {
    ...
    private SdrUsersServiceClpInvoker _clpInvoker = new SdrUsersServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.SdrUsersServiceUtil} to access the sdr users remote service.
     */
