...
import com.sdr.metadata.service.DataTypeSchemaService;
...
/**
 * Provides the base implementation for the data type schema remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DataTypeSchemaServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class DataTypeSchemaServiceBaseImpl extends BaseServiceImpl
    implements DataTypeSchemaService, IdentifiableBean {
    ...
    private DataTypeSchemaServiceClpInvoker _clpInvoker = new DataTypeSchemaServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DataTypeSchemaServiceUtil} to access the data type schema remote service.
     */
