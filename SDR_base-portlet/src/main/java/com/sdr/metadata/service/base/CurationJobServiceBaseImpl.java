...
import com.sdr.metadata.service.CurationJobService;
...
/**
 * Provides the base implementation for the curation job remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.CurationJobServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class CurationJobServiceBaseImpl extends BaseServiceImpl
    implements CurationJobService, IdentifiableBean {
    ...
    private CurationJobServiceClpInvoker _clpInvoker = new CurationJobServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.CurationJobServiceUtil} to access the curation job remote service.
     */
