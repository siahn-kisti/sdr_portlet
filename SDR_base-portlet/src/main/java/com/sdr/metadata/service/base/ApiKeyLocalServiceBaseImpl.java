...
import com.sdr.metadata.service.ApiKeyLocalService;
...
/**
 * Provides the base implementation for the api key local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.ApiKeyLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class ApiKeyLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements ApiKeyLocalService, IdentifiableBean {
    ...
    private ApiKeyLocalServiceClpInvoker _clpInvoker = new ApiKeyLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.ApiKeyLocalServiceUtil} to access the api key local service.
     */
    ...
    @Override
    public ApiKey addApiKey(ApiKey apiKey) throws SystemException {
        apiKey.setNew(true);

        return apiKeyPersistence.update(apiKey);
    }
    ...
    public ApiKey createApiKey(long userId) {
        return apiKeyPersistence.create(userId);
    }
    ...
    @Override
    public ApiKey deleteApiKey(long userId)
        throws PortalException, SystemException {
        return apiKeyPersistence.remove(userId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ApiKey deleteApiKey(ApiKey apiKey) throws SystemException {
        return apiKeyPersistence.remove(apiKey);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ApiKey.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return apiKeyPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return apiKeyPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return apiKeyPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return apiKeyPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public ApiKey fetchApiKey(long userId) throws SystemException {
        return apiKeyPersistence.fetchByPrimaryKey(userId);
    }
     ...
     */
    @Override
    public ApiKey getApiKey(long userId)
        throws PortalException, SystemException {
        return apiKeyPersistence.findByPrimaryKey(userId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return apiKeyPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ApiKey> getApiKeies(int start, int end)
        throws SystemException {
        return apiKeyPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getApiKeiesCount() throws SystemException {
        return apiKeyPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ApiKey updateApiKey(ApiKey apiKey) throws SystemException {
        return apiKeyPersistence.update(apiKey);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.ApiKey",
            apiKeyLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "com.sdr.metadata.model.ApiKey");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = apiKeyPersistence.getDataSource();
