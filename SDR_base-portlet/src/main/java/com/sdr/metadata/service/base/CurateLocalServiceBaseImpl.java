...
import com.sdr.metadata.service.CurateLocalService;
...
/**
 * Provides the base implementation for the curate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.CurateLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class CurateLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements CurateLocalService, IdentifiableBean {
    ...
    private CurateLocalServiceClpInvoker _clpInvoker = new CurateLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.CurateLocalServiceUtil} to access the curate local service.
     */
    ...
    @Override
    public Curate addCurate(Curate curate) throws SystemException {
        curate.setNew(true);

        return curatePersistence.update(curate);
    }
     ...
     */
    @Override
    public Curate createCurate(long curateId) {
        return curatePersistence.create(curateId);
    }
    ...
    @Override
    public Curate deleteCurate(long curateId)
        throws PortalException, SystemException {
        return curatePersistence.remove(curateId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Curate deleteCurate(Curate curate) throws SystemException {
        return curatePersistence.remove(curate);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Curate.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return curatePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return curatePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return curatePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return curatePersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Curate fetchCurate(long curateId) throws SystemException {
        return curatePersistence.fetchByPrimaryKey(curateId);
    }
     ...
     */
    @Override
    public Curate getCurate(long curateId)
        throws PortalException, SystemException {
        return curatePersistence.findByPrimaryKey(curateId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return curatePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Curate> getCurates(int start, int end)
        throws SystemException {
        return curatePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCuratesCount() throws SystemException {
        return curatePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Curate updateCurate(Curate curate) throws SystemException {
        return curatePersistence.update(curate);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.Curate",
            curateLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = curatePersistence.getDataSource();
