...
import com.sdr.metadata.service.DataViewComponentsService;
...
/**
 * Provides the base implementation for the data view components remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DataViewComponentsServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class DataViewComponentsServiceBaseImpl extends BaseServiceImpl
    implements DataViewComponentsService, IdentifiableBean {
    ...
    private DataViewComponentsServiceClpInvoker _clpInvoker = new DataViewComponentsServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DataViewComponentsServiceUtil} to access the data view components remote service.
     */
