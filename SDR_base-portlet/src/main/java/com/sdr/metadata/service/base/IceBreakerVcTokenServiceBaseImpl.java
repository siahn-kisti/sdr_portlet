...
import com.sdr.metadata.service.IceBreakerVcTokenService;
...
/**
 * Provides the base implementation for the ice breaker vc token remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.IceBreakerVcTokenServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class IceBreakerVcTokenServiceBaseImpl extends BaseServiceImpl
    implements IceBreakerVcTokenService, IdentifiableBean {
    ...
    private IceBreakerVcTokenServiceClpInvoker _clpInvoker = new IceBreakerVcTokenServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.IceBreakerVcTokenServiceUtil} to access the ice breaker vc token remote service.
     */
