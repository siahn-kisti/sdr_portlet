...
import com.sdr.metadata.service.SdrOrganizationsService;
...
/**
 * Provides the base implementation for the sdr organizations remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.SdrOrganizationsServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class SdrOrganizationsServiceBaseImpl extends BaseServiceImpl
    implements SdrOrganizationsService, IdentifiableBean {
    ...
    private SdrOrganizationsServiceClpInvoker _clpInvoker = new SdrOrganizationsServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.SdrOrganizationsServiceUtil} to access the sdr organizations remote service.
     */
