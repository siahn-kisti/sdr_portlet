...
/**
 * Provides the base implementation for the simulation job local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.SimulationJobLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class SimulationJobLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SimulationJobLocalService,
        IdentifiableBean {
    ...
    private SimulationJobLocalServiceClpInvoker _clpInvoker = new SimulationJobLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.SimulationJobLocalServiceUtil} to access the simulation job local service.
     */
    ...
    @Override
    public SimulationJob addSimulationJob(SimulationJob simulationJob)
     ...
     */
    @Override
    public SimulationJob createSimulationJob(long simulationId) {
        return simulationJobPersistence.create(simulationId);
    }
    ...
    @Override
    public SimulationJob deleteSimulationJob(long simulationId)
        throws PortalException, SystemException {
        return simulationJobPersistence.remove(simulationId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public SimulationJob deleteSimulationJob(SimulationJob simulationJob)
        throws SystemException {
        return simulationJobPersistence.remove(simulationJob);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(SimulationJob.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return simulationJobPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return simulationJobPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public SimulationJob fetchSimulationJob(long simulationId)
        throws SystemException {
        return simulationJobPersistence.fetchByPrimaryKey(simulationId);
    }
     ...
     */
    @Override
    public SimulationJob getSimulationJob(long simulationId)
        throws PortalException, SystemException {
        return simulationJobPersistence.findByPrimaryKey(simulationId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return simulationJobPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<SimulationJob> getSimulationJobs(int start, int end)
        throws SystemException {
        return simulationJobPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSimulationJobsCount() throws SystemException {
        return simulationJobPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public SimulationJob updateSimulationJob(SimulationJob simulationJob)
        throws SystemException {
        return simulationJobPersistence.update(simulationJob);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.SimulationJob",
            simulationJobLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = simulationJobPersistence.getDataSource();
