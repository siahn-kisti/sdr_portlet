...
import com.sdr.metadata.service.Collection_UserService;
...
/**
 * Provides the base implementation for the collection_ user remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.Collection_UserServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class Collection_UserServiceBaseImpl extends BaseServiceImpl
    implements Collection_UserService, IdentifiableBean {
    ...
    private Collection_UserServiceClpInvoker _clpInvoker = new Collection_UserServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.Collection_UserServiceUtil} to access the collection_ user remote service.
     */
