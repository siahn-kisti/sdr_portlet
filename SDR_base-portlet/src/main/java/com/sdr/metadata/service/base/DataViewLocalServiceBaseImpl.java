...
import com.sdr.metadata.service.DataViewLocalService;
...
/**
 * Provides the base implementation for the data view local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.DataViewLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class DataViewLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements DataViewLocalService, IdentifiableBean {
    ...
    private DataViewLocalServiceClpInvoker _clpInvoker = new DataViewLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.DataViewLocalServiceUtil} to access the data view local service.
     */
    ...
    @Override
    public DataView addDataView(DataView dataView) throws SystemException {
        dataView.setNew(true);

        return dataViewPersistence.update(dataView);
    }
     ...
     */
    @Override
    public DataView createDataView(long dataViewId) {
        return dataViewPersistence.create(dataViewId);
    }
    ...
    @Override
    public DataView deleteDataView(long dataViewId)
        throws PortalException, SystemException {
        return dataViewPersistence.remove(dataViewId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public DataView deleteDataView(DataView dataView) throws SystemException {
        return dataViewPersistence.remove(dataView);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DataView.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return dataViewPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return dataViewPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
        ...
        return dataViewPersistence.findWithDynamicQuery(dynamicQuery, start,
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return dataViewPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DataView fetchDataView(long dataViewId) throws SystemException {
        return dataViewPersistence.fetchByPrimaryKey(dataViewId);
    }
    ...
    public DataView getDataView(long dataViewId)
        throws PortalException, SystemException {
        return dataViewPersistence.findByPrimaryKey(dataViewId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return dataViewPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DataView> getDataViews(int start, int end)
        throws SystemException {
        return dataViewPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDataViewsCount() throws SystemException {
        return dataViewPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DataView updateDataView(DataView dataView) throws SystemException {
        return dataViewPersistence.update(dataView);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.DataView",
            dataViewLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = dataViewPersistence.getDataSource();
