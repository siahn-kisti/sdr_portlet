...
import com.sdr.metadata.service.SdrOrganizationsLocalService;
...
/**
 * Provides the base implementation for the sdr organizations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.SdrOrganizationsLocalServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class SdrOrganizationsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SdrOrganizationsLocalService,
        IdentifiableBean {
    ...
    private SdrOrganizationsLocalServiceClpInvoker _clpInvoker = new SdrOrganizationsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.SdrOrganizationsLocalServiceUtil} to access the sdr organizations local service.
     */
    ...
    @Override
    public SdrOrganizations addSdrOrganizations(
        SdrOrganizations sdrOrganizations) throws SystemException {
        sdrOrganizations.setNew(true);

        return sdrOrganizationsPersistence.update(sdrOrganizations);
    }
     ...
     */
    @Override
    public SdrOrganizations createSdrOrganizations(long organizationId) {
        return sdrOrganizationsPersistence.create(organizationId);
    }
    ...
    @Override
    public SdrOrganizations deleteSdrOrganizations(long organizationId)
        throws PortalException, SystemException {
        return sdrOrganizationsPersistence.remove(organizationId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public SdrOrganizations deleteSdrOrganizations(
        SdrOrganizations sdrOrganizations) throws SystemException {
        return sdrOrganizationsPersistence.remove(sdrOrganizations);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(SdrOrganizations.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return sdrOrganizationsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return sdrOrganizationsPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public SdrOrganizations fetchSdrOrganizations(long organizationId)
        throws SystemException {
        return sdrOrganizationsPersistence.fetchByPrimaryKey(organizationId);
    }
     ...
     */
    @Override
    public SdrOrganizations getSdrOrganizations(long organizationId)
        throws PortalException, SystemException {
        return sdrOrganizationsPersistence.findByPrimaryKey(organizationId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return sdrOrganizationsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<SdrOrganizations> getSdrOrganizationses(int start, int end)
        throws SystemException {
        return sdrOrganizationsPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getSdrOrganizationsesCount() throws SystemException {
        return sdrOrganizationsPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public SdrOrganizations updateSdrOrganizations(
        SdrOrganizations sdrOrganizations) throws SystemException {
        return sdrOrganizationsPersistence.update(sdrOrganizations);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.sdr.metadata.model.SdrOrganizations",
            sdrOrganizationsLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = sdrOrganizationsPersistence.getDataSource();
