...
import com.sdr.metadata.service.ApiKeyService;
...
/**
 * Provides the base implementation for the api key remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.ApiKeyServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class ApiKeyServiceBaseImpl extends BaseServiceImpl
    implements ApiKeyService, IdentifiableBean {
    ...
    private ApiKeyServiceClpInvoker _clpInvoker = new ApiKeyServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.ApiKeyServiceUtil} to access the api key remote service.
     */
