...
import com.sdr.metadata.service.ReqMakeSiteService;
...
/**
 * Provides the base implementation for the req make site remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sdr.metadata.service.impl.ReqMakeSiteServiceImpl}.
 * </p>
 *
 * @author jaesung
 ...
 * @generated
 */
public abstract class ReqMakeSiteServiceBaseImpl extends BaseServiceImpl
    implements ReqMakeSiteService, IdentifiableBean {
    ...
    private ReqMakeSiteServiceClpInvoker _clpInvoker = new ReqMakeSiteServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.sdr.metadata.service.ReqMakeSiteServiceUtil} to access the req make site remote service.
     */
