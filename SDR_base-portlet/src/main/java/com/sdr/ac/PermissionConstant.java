...
public class PermissionConstant {
    ...
    public static Hits checkAndQuery(ServiceContext serviceContext, SearchContext searchContext, BooleanQuery mainQuery)
        ...
        return checkAndQuery(serviceContext, searchContext, mainQuery, null, null);
    }

    public static Hits checkAndQuery(ServiceContext serviceContext, SearchContext searchContext,  BooleanQuery mainQuery,
            SearchContainer searchContainer, Sort[] sorts) throws SearchException, PortalException {
        if (PermissionConstant.SDR_AC_DISABLE) {
            ...
            if (sorts == null) {
                ...
                return SearchEngineUtil.search(SearchEngineUtil.SYSTEM_ENGINE_ID, serviceContext.getCompanyId(),
                        mainQuery, sorts, searchContainer.getStart(), searchContainer.getEnd());
            }
        }
