/**
 * this file sun.nio.fs.Globs copy..
 */
...
public class Globs {
	 ...
	 * @return the string
	 */
	public static String toRegexPattern(String var0, boolean var1) {
		boolean var2 = false;
	...
	/**
	 * To windows regex pattern string.
	 *
	 * @param var0 the var 0
	 * @return the string
	 */
