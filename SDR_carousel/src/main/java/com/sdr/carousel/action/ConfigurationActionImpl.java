package com.sdr.carousel.action;
...
public class ConfigurationActionImpl implements ConfigurationAction {
    ...
    public String render(PortletConfig portletConfig, RenderRequest renderRequest, RenderResponse renderResponse) throws Exception {
        ...
        return "/WEB-INF/jsp/SDR_carousel/config/configuration.jsp";
    ...
    private void updateSlideOrder(PortletRequest request, PortletResponse response, boolean slideDown) throws Exception {
    ...
    private void updateSettings(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            if (param.startsWith("settings")) {
                ...
                _log.info("save param=" + param + ", value=" + value);
    ...
    private void savePreferences(ActionRequest request, ActionResponse response) throws Exception {
        ...
        if (sliderArticle != null) {
            ...
            for (String currentLanguageId : availableLanguages) {
                ...
                JournalArticle ja = JournalArticleLocalServiceUtil.getArticle(groupId, articleId);
                String currentLink = "/-/" + ja.getUrlTitle();
                _log.info("set Link : " + currentLink);
    ...
    private void saveSlideOrder(PortletRequest request, PortletResponse response, Slide slide, int order) throws Exception {
        ...
        for (String languageId : languages) {
            ...
            if (isValid(title, image)) {
                ...
                String[] values = new String[]{title, link, desc, image, String.valueOf(slide.getTimeMillis()), String.valueOf(order)};
