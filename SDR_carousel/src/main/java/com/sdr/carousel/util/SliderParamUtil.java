...
public interface SliderParamUtil {
		...
		String SETTINGS_SLICES = "settings-slices";
		String SETTINGS_BOX_COLUMN = "settings-boxColumn";
		String SETTINGS_ANIMATION_SPEED = "settings-animationSpeed";
		String SETTINGS_PAUSE_TIME = "settings-pauseTime";
		...
		String SETTINGS_SLIDE_WIDTH = "settings-slide-width";
		String SETTINGS_SLIDE_HEIGHT = "settings-slide-height";
}
