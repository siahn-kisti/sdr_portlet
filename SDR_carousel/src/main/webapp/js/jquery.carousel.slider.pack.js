/*
 * jquery.carousel.slider.pack.js v1.6.2.2
 */

(function (a) {
    var b = function (b, c) {
        var d = a.extend({}, a.fn.scsSlider.defaults, c);
        var e = {currentSlide: 0, currentImage: "", totalSlides: 0, running: false, paused: false, stop: false};
        var f = a(b);
        f.data("scs:vars", e);
        f.css("position", "relative");
        f.addClass("scsSlider");
        var g = f.children();
        g.each(function () {
            var b = a(this);
            var c = "";
        ...
        f.append(a('<div class="scs-caption"><p></p></div>').css({display: "none", opacity: d.captionOpacity}));
        a(".scs-caption", f).css("opacity", 0);
        var h = function (b) {
            var c = a(".scs-caption", f);
        ...
        if (d.directionNav) {
            f.append('<div class="scs-directionNav"><div class="scsPrevArea"><a class="scs-prevNav">' + d.prevText + '</a></div><div class="scsNextArea"><a class="scs-nextNav">' + d.nextText + "</a></div></div>");
            if (d.directionNavHide) {
                a(".scs-directionNav", f).hide();
                f.hover(function () {
                    a(".scs-directionNav", f).show()
                }, function () {
                    a(".scs-directionNav", f).hide()
                })
            }
            a("div.scsPrevArea, scs-prevNav", f).live("click", function () {
            ...
            a("div.scsNextArea, scs-nextNav", f).live("click", function () {
                if (e.running) return false;
                clearInterval(i);
                i = "";
                o(f, g, d, "next")
        ...
        if (d.controlNav) {
            var j = a('<div class="scs-controlNav"></div>');
            f.append(j);
            for (var k = 0; k < g.length; k++) {
                if (d.controlNavThumbs) {
                    ...
                    if (d.controlNavThumbsFromRel) {
                        j.append('<a class="scs-control" rel="' + k + '"><img src="' + l.attr("rel") + '" alt="" /></a>')
                    } else {
                        j.append('<a class="scs-control" rel="' + k + '"><img src="' + l.attr("src").replace(d.controlNavThumbsSearch, d.controlNavThumbsReplace) + '" alt="" /></a>')
                    }
                } else {
                    j.append('<a class="scs-control" rel="' + k + '">' + (k + 1) + "</a>")
                }
            }
            a(".scs-controlNav a:eq(" + e.currentSlide + ")", f).addClass("active");
            a(".scs-controlNav a", f).live("click", function () {
                if (e.running) return false;
        ...
        f.bind("scs:animFinished", function () {
            e.running = false;
            a(g).each(function () {
                if (a(this).is("a")) {
        ...
        var m = function (b, c, d) {
            for (var e = 0; e < c.slices; e++) {
                ...
                if (e == c.slices - 1) {
                    b.append(a('<div class="scs-slice"></div>').css({left: f * e + "px", width: b.width() - f * e + "px", height: "0px", opacity: "0", background: 'url("' + d.currentImage.attr("src") + '") no-repeat -' + (f + e * f - f) + "px 0%"}))
                } else {
                    b.append(a('<div class="scs-slice"></div>').css({left: f * e + "px", width: f + "px", height: "0px", opacity: "0", background: 'url("' + d.currentImage.attr("src") + '") no-repeat -' + (f + e * f - f) + "px 0%"}))
                }
            }
        };
        var n = function (b, c, d) {
            ...
            for (var g = 0; g < c.boxRows; g++) {
                for (var h = 0; h < c.boxCols; h++) {
                    if (h == c.boxCols - 1) {
                        b.append(a('<div class="scs-box"></div>').css({opacity: 0, left: e * h + "px", top: f * g + "px", width: b.width() - e * h + "px", height: f + "px", background: 'url("' + d.currentImage.attr("src") + '") no-repeat -' + (e + h * e - e) + "px -" + (f + g * f - f) + "px"}))
                    } else {
                        b.append(a('<div class="scs-box"></div>').css({opacity: 0, left: e * h + "px", top: f * g + "px", width: e + "px", height: f + "px", background: 'url("' + d.currentImage.attr("src") + '") no-repeat -' + (e + h * e - e) + "px -" + (f + g * f - f) + "px"}))
                    }
                }
            }
        };
        var o = function (b, c, d, e) {
            var f = b.data("scs:vars");
            ...
            if (d.controlNav) {
                a(".scs-controlNav a", b).removeClass("active");
                a(".scs-controlNav a:eq(" + f.currentSlide + ")", b).addClass("active")
            }
            h(d);
            a(".scs-slice", b).remove();
            a(".scs-box", b).remove();
            var g = d.effect;
            if (d.effect == "random") {
            ...
            if (g == "sliceDown" || g == "sliceDownRight" || g == "sliceDownLeft") {
                ...
                var k = 0;
                var l = a(".scs-slice", b);
                if (g == "sliceDownLeft") l = a(".scs-slice", b)._reverse();
                l.each(function () {
                    var c = a(this);
                    c.css({top: "0px"});
                    if (k == d.slices - 1) {
                ...
                var k = 0;
                var l = a(".scs-slice", b);
                if (g == "sliceUpLeft") l = a(".scs-slice", b)._reverse();
                l.each(function () {
                    var c = a(this);
                    c.css({bottom: "0px"});
                    if (k == d.slices - 1) {
                ...
                var o = 0;
                var l = a(".scs-slice", b);
                if (g == "sliceUpDownLeft") l = a(".scs-slice", b)._reverse();
                l.each(function () {
                    var c = a(this);
                    if (k == 0) {
                        c.css("top", "0px");
        ...
        this.stop = function () {
            if (!a(b).data("scs:vars").stop) {
                a(b).data("scs:vars").stop = true;
                q("Stop Slider")
            }
        };
        this.start = function () {
            if (a(b).data("scs:vars").stop) {
                a(b).data("scs:vars").stop = false;
                q("Start Slider")
            }
        };
    ...
    a.fn.scsSlider = function (c) {
        return this.each(function (d, e) {
            var f = a(this);
            if (f.data("scsslider")) return f.data("scsslider");
            var g = new b(this, c);
            f.data("scsslider", g)
        })
    };
    a.fn.scsSlider.defaults = {
        effect: "random", slices: 15, boxCols: 8, boxRows: 4, animSpeed: 500, pauseTime: 3e3, startSlide: 0, directionNav: true, directionNavHide: true, controlNav: true, controlNavThumbs: false, controlNavThumbsFromRel: false, controlNavThumbsSearch: ".jpg", controlNavThumbsReplace: "_thumb.jpg", keyboardNav: true, pauseOnHover: true, manualAdvance: false, captionOpacity: .8, prevText: "Prev", nextText: "Next", randomStart: false, beforeChange: function () {
