...
/**
 * Provides the local service interface for Popup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author goopsw
 * @see PopupLocalServiceUtil
...
public interface PopupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PopupLocalServiceUtil} to access the popup local service. Add custom service methods to {@link com.sdr.popup.service.impl.PopupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
