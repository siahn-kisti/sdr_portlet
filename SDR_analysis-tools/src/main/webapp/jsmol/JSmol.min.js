...
a._getZ(b,"coverImage")+';" />';d=a._appletCssText.replace(/\'/g,'"');var k=b._getSpinner&&b._getSpinner();b._spinner=k=!k||"none"==k?"":"background-image:url("+k+"); background-repeat:no-repeat; background-position:center;";d=k+(0<=d.indexOf('style="')?d.split('style="')[1]:'" '+d);d='...<div id="ID_appletinfotablediv" style="width:Wpx;height:Hpx;position:relative;font-size:14px;text-align:left">IMG WAIT......<div id="ID_appletdiv" style="z-index:'+1+";width:100%;height:100%;position:absolute;top:0px;left:0px;"+
