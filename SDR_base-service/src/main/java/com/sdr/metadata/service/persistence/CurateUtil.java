...
/**
 * The persistence utility for the curate service. This utility wraps {@link CuratePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CurateUtil {
    private static CuratePersistence _persistence;
     ...
     */
    public static void clearCache(Curate curate) {
        getPersistence().clearCache(curate);
    }
     ...
     */
    public static List<Curate> findWithDynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
     ...
     */
    public static Curate update(Curate curate) throws SystemException {
        return getPersistence().update(curate);
    }

    /**
     * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
     */
    public static Curate update(Curate curate, ServiceContext serviceContext)
        throws SystemException {
        return getPersistence().update(curate, serviceContext);
    }
    ...
    */
    public static java.util.List<com.sdr.metadata.model.Curate> findByDataset(
        long datasetId)
    ...
    */
    public static java.util.List<com.sdr.metadata.model.Curate> findByDataset(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findByDataset(datasetId, start, end, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate findByDataset_First(
        long datasetId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.sdr.metadata.NoSuchCurateException {
        return getPersistence().findByDataset_First(datasetId, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate fetchByDataset_First(
        long datasetId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchByDataset_First(datasetId, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate findByDataset_Last(
        long datasetId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.sdr.metadata.NoSuchCurateException {
        return getPersistence().findByDataset_Last(datasetId, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate fetchByDataset_Last(
        long datasetId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().fetchByDataset_Last(datasetId, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate[] findByDataset_PrevAndNext(
        long curateId, long datasetId,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.sdr.metadata.NoSuchCurateException {
        return getPersistence()
                   .findByDataset_PrevAndNext(curateId, datasetId,
            orderByComparator);
    }
    ...
    */
    public static void cacheResult(com.sdr.metadata.model.Curate curate) {
        getPersistence().cacheResult(curate);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(curates);
    }
    ...
    */
    public static com.sdr.metadata.model.Curate create(long curateId) {
        return getPersistence().create(curateId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate remove(long curateId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.sdr.metadata.NoSuchCurateException {
        return getPersistence().remove(curateId);
    }

    public static com.sdr.metadata.model.Curate updateImpl(
        com.sdr.metadata.model.Curate curate)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(curate);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate findByPrimaryKey(long curateId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.sdr.metadata.NoSuchCurateException {
        return getPersistence().findByPrimaryKey(curateId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.Curate fetchByPrimaryKey(long curateId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().fetchByPrimaryKey(curateId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.sdr.metadata.model.Curate> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static CuratePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (CuratePersistence) PortletBeanLocatorUtil.locate(com.sdr.metadata.service.ClpSerializer.getServletContextName(),
                    CuratePersistence.class.getName());

            ReferenceRegistry.registerReference(CurateUtil.class, "_persistence");
        }
     ...
     */
    public void setPersistence(CuratePersistence persistence) {
    }
}
