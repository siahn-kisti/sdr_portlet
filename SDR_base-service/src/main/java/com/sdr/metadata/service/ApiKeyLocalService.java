...
/**
 * Provides the local service interface for ApiKey. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jaesung
 * @see ApiKeyLocalServiceUtil
...
public interface ApiKeyLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ApiKeyLocalServiceUtil} to access the api key local service. Add custom service methods to {@link com.sdr.metadata.service.impl.ApiKeyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
