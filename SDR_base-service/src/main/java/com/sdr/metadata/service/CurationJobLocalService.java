...
/**
 * Provides the local service interface for CurationJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jaesung
 * @see CurationJobLocalServiceUtil
...
public interface CurationJobLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CurationJobLocalServiceUtil} to access the curation job local service. Add custom service methods to {@link com.sdr.metadata.service.impl.CurationJobLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
