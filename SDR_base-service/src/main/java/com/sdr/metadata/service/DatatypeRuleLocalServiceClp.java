 ...
 * @generated
 */
public class DatatypeRuleLocalServiceClp implements DatatypeRuleLocalService {
    ...
    public DatatypeRuleLocalServiceClp(
        ...
        _methodName19 = "getGrIdDatatypeRule";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "addDatatypeRule";

        _methodParameterTypes20 = new String[] { "long", "long", "long" };

        _methodName21 = "updateDatatypeRule";
    ...
    public com.sdr.metadata.model.DatatypeRule addDatatypeRule(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(datatypeRule) });
        } catch (Throwable t) {
    ...
    public com.sdr.metadata.model.DatatypeRule createDatatypeRule(long drId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { drId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.metadata.model.DatatypeRule deleteDatatypeRule(long drId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { drId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.metadata.model.DatatypeRule fetchDatatypeRule(long drId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { drId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.metadata.model.DatatypeRule getDatatypeRule(long drId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { drId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.metadata.model.DatatypeRule> getDatatypeRules(
        ...
        return (java.util.List<com.sdr.metadata.model.DatatypeRule>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.metadata.model.DatatypeRule getGrIdDatatypeRule(long grId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { grId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
