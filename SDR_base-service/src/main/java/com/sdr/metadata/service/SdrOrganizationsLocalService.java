...
/**
 * Provides the local service interface for SdrOrganizations. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jaesung
 * @see SdrOrganizationsLocalServiceUtil
...
public interface SdrOrganizationsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SdrOrganizationsLocalServiceUtil} to access the sdr organizations local service. Add custom service methods to {@link com.sdr.metadata.service.impl.SdrOrganizationsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
