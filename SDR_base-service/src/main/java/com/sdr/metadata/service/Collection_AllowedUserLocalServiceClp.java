 ...
 * @generated
 */
public class Collection_AllowedUserLocalServiceClp
    ...
    public Collection_AllowedUserLocalServiceClp(
        ...
        _methodName19 = "addCollection_AllowedUser";

        _methodParameterTypes19 = new String[] { "long", "long" };

        _methodName20 = "deleteCollection_AllowedUser";

        _methodParameterTypes20 = new String[] { "long", "long" };

        _methodName21 = "getCollectionsByAllowedUser";

        _methodParameterTypes21 = new String[] { "long" };

        _methodName22 = "getAllowedUsersByCollection";

        _methodParameterTypes22 = new String[] { "long" };

        _methodName23 = "getAllowedUsersNameByCollection";

        _methodParameterTypes23 = new String[] { "long" };

        _methodName24 = "deleteCollection_AllowedUser";
    ...
    public com.sdr.metadata.model.Collection_AllowedUser addCollection_AllowedUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(collection_AllowedUser)
                    });
        } catch (Throwable t) {
        ...
        return (com.sdr.metadata.model.Collection_AllowedUser) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.metadata.model.Collection_AllowedUser createCollection_AllowedUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(collection_AllowedUserPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.metadata.model.Collection_AllowedUser> getCollection_AllowedUsers(
        ...
        return (java.util.List<com.sdr.metadata.model.Collection_AllowedUser>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.metadata.model.Collection_AllowedUser addCollection_AllowedUser(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    new Object[] { CollectionID, userId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.metadata.model.Collection_AllowedUser> getAllowedUsersByCollection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    _methodParameterTypes22, new Object[] { CollectionID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.liferay.portal.model.User> getAllowedUsersNameByCollection(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName23,
                    _methodParameterTypes23, new Object[] { collectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
