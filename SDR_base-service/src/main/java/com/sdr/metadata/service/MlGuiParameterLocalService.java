...
/**
 * Provides the local service interface for MlGuiParameter. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author jaesung
 * @see MlGuiParameterLocalServiceUtil
...
public interface MlGuiParameterLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link MlGuiParameterLocalServiceUtil} to access the ml gui parameter local service. Add custom service methods to {@link com.sdr.metadata.service.impl.MlGuiParameterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
