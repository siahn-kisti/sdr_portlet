...
/**
 * Provides the local service utility for SdrUsers. This utility wraps
 * {@link com.sdr.metadata.service.impl.SdrUsersLocalServiceImpl} and is the
 ...
 * @generated
 */
public class SdrUsersLocalServiceUtil {
    private static SdrUsersLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.sdr.metadata.service.impl.SdrUsersLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.sdr.metadata.model.SdrUsers addSdrUsers(
        com.sdr.metadata.model.SdrUsers sdrUsers)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addSdrUsers(sdrUsers);
    }
    ...
    */
    public static com.sdr.metadata.model.SdrUsers createSdrUsers(long userId) {
        return getService().createSdrUsers(userId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.SdrUsers deleteSdrUsers(long userId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteSdrUsers(userId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.SdrUsers deleteSdrUsers(
        com.sdr.metadata.model.SdrUsers sdrUsers)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteSdrUsers(sdrUsers);
    }
    ...
    */
    ...
    public static com.sdr.metadata.model.SdrUsers fetchSdrUsers(long userId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchSdrUsers(userId);
    }
    ...
    */
    public static com.sdr.metadata.model.SdrUsers getSdrUsers(long userId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getSdrUsers(userId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.sdr.metadata.model.SdrUsers> getSdrUserses(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getSdrUserses(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getSdrUsersesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getSdrUsersesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.sdr.metadata.model.SdrUsers updateSdrUsers(
        com.sdr.metadata.model.SdrUsers sdrUsers)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateSdrUsers(sdrUsers);
    }
    ...
    * @throws SystemException
    */
    public static java.util.List<com.sdr.metadata.model.SdrUsers> getList(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static SdrUsersLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    SdrUsersLocalService.class.getName());

            if (invokableLocalService instanceof SdrUsersLocalService) {
                _service = (SdrUsersLocalService) invokableLocalService;
            } else {
                _service = new SdrUsersLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(SdrUsersLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(SdrUsersLocalService service) {
    }
}
