 ...
 * @generated
 */
public class CollectionLocalServiceClp implements CollectionLocalService {
    ...
    public CollectionLocalServiceClp(
        ...
        _methodName22 = "getCollectionIds";

        _methodParameterTypes22 = new String[] {  };

        _methodName23 = "collectionCommunityMap";

        _methodParameterTypes23 = new String[] {  };

        _methodName24 = "getList";

        _methodParameterTypes24 = new String[] { "int", "int" };

        _methodName25 = "getListOrderBy";
        ...
        _methodName26 = "getList";

        _methodParameterTypes26 = new String[] { "int", "int", "java.lang.String" };

        _methodName27 = "getList";

        _methodParameterTypes27 = new String[] { "long" };

        _methodName28 = "getList";
        ...
        _methodName32 = "getCount";

        _methodParameterTypes32 = new String[] { "long" };

        _methodName33 = "getListByDatasetUserId";

        _methodParameterTypes33 = new String[] { "long" };

        _methodName34 = "getListByDatasetUserId";

        _methodParameterTypes34 = new String[] { "long", "int", "int" };

        _methodName35 = "getCountByDatasetUserId";
        ...
        _methodName43 = "delete";

        _methodParameterTypes43 = new String[] {
                "java.lang.Long", "com.liferay.portal.service.ServiceContext"
            };

        _methodName44 = "getRelatedAsset";

        _methodParameterTypes44 = new String[] {
                "com.liferay.portlet.asset.model.AssetEntry", "java.lang.String"
            };

        _methodName45 = "getRelatedArticle";

        _methodParameterTypes45 = new String[] { "long" };

        _methodName46 = "getRelatedFileEntry";

        _methodParameterTypes46 = new String[] { "long" };

        _methodName47 = "reindexAllCollections";
    ...
    public com.sdr.metadata.model.Collection getCollection(long collectionId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { collectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public long getGroupId(long collectionId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { collectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.metadata.model.Collection> getListByDatasetUserId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName33,
                    _methodParameterTypes33, new Object[] { datasetUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.metadata.model.Collection> getListByDatasetUserId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName34,
                    ...
                    new Object[] { datasetUserId, start, end });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int getCountByDatasetUserId(long datasetUserId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName35,
                    _methodParameterTypes35, new Object[] { datasetUserId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.Map<java.lang.String, java.lang.Object> search(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName38,
                    ...
                    ClpSerializer.translateInput(renderURL)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.Map<java.lang.String, java.lang.Object> convertVoToMap(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName39,
                    ...
                    new Object[] { ClpSerializer.translateInput(collectionList) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.metadata.model.Collection setPermission(long collectionId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName40,
                    ...
                    new Object[] { collectionId, accessPolicy });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.lang.Object getRelatedAsset(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName44,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(assetEntry),
    ...
    public com.liferay.portlet.journal.model.JournalArticle getRelatedArticle(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName45,
                    _methodParameterTypes45, new Object[] { collectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
        ...
        return (com.liferay.portlet.journal.model.JournalArticle) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.liferay.portlet.documentlibrary.model.DLFileEntry getRelatedFileEntry(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName46,
                    _methodParameterTypes46, new Object[] { collectionId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
