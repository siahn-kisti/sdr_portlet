 ...
 * @generated
 */
public class BbsCommentLocalServiceClp implements BbsCommentLocalService {
    ...
    public BbsCommentLocalServiceClp(
        ...
        _methodName19 = "countByPostId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "findByPostId";
    ...
    public com.sdr.bbs.model.BbsComment addBbsComment(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(bbsComment) });
        } catch (Throwable t) {
        ...
        return (com.sdr.bbs.model.BbsComment) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.sdr.bbs.model.BbsComment> getBbsComments(
        ...
        return (java.util.List<com.sdr.bbs.model.BbsComment>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int countByPostId(long postId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { postId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.bbs.model.BbsComment> findByPostId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    _methodParameterTypes20, new Object[] { postId, start, end });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
