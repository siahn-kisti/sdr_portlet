 ...
 * @generated
 */
public class BbsLocalServiceClp implements BbsLocalService {
    ...
    public BbsLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.sdr.bbs.model.Bbs addBbs(com.sdr.bbs.model.Bbs bbs)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(bbs) });
        } catch (Throwable t) {
        ...
        return (com.sdr.bbs.model.Bbs) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.bbs.model.Bbs createBbs(long bbsId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { bbsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.bbs.model.Bbs deleteBbs(long bbsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { bbsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.bbs.model.Bbs fetchBbs(long bbsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { bbsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.bbs.model.Bbs getBbs(long bbsId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { bbsId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.bbs.model.Bbs> getBbses(int start, int end)
        ...
        return (java.util.List<com.sdr.bbs.model.Bbs>) ClpSerializer.translateOutput(returnObj);
    }
