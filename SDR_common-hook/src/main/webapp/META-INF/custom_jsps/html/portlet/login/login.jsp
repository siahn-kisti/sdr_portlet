...
<style>
    ...
    .fieldset>div>div.control-group {

    }
    .fieldset>div>div.control-group .control-label {
        font-size:12px;
    }
    .fieldset>div>div.control-group .field {
        width: 100%;
        height: 35px;
    ...
    .fieldset>div>div.control-group .checkbox {
        width: 100%;
    }
    .fieldset>div>div.control-group .checkbox .field {
        width: auto;
        height: auto;
    }
    .button-holder .btn {
    ...
    .portlet-body .navigation { background-color: #fff;
        border:0;
        background: none;
...
<h4 class="signin-title">SIGNIN</h4>
