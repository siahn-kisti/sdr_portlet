 ...
 * @generated
 */
public class GuideLocalServiceClp implements GuideLocalService {
    ...
    public GuideLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.sdr.guide.model.Guide addGuide(com.sdr.guide.model.Guide guide)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(guide) });
        } catch (Throwable t) {
        ...
        return (com.sdr.guide.model.Guide) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.guide.model.Guide createGuide(long datasetId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { datasetId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.guide.model.Guide deleteGuide(long datasetId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { datasetId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.guide.model.Guide fetchGuide(long datasetId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { datasetId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.sdr.guide.model.Guide getGuide(long datasetId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName13,
                    _methodParameterTypes13, new Object[] { datasetId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.sdr.guide.model.Guide> getGuides(int start,
        ...
        return (java.util.List<com.sdr.guide.model.Guide>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.sdr.guide.model.Guide delete(java.lang.Long datasetId,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName26,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(datasetId),
