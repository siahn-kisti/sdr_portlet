...
/**
 * Provides the local service interface for Guide. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author heesangbb
 * @see GuideLocalServiceUtil
...
public interface GuideLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link GuideLocalServiceUtil} to access the guide local service. Add custom service methods to {@link com.sdr.guide.service.impl.GuideLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
